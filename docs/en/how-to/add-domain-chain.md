...
description: "Step-by-step guide to creating a new Sub-Chain using HierarchyManager and/or API v1, recording events, and submitting proofs."
...
Reference signatures and status codes: see [Reference: API v1](../reference/api-v1.md).
...
* Sub-chain not showing in list → try `GET /api/v1/chains` to verify and see `block_count`.
